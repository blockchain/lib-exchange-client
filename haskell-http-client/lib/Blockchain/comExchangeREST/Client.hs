...
module Blockchain.comExchangeREST.Client where
...
dispatchLbs
  ...
  -> comExchangeRESTConfig -- ^ config
  -> comExchangeRESTRequest req contentType res accept -- ^ request
