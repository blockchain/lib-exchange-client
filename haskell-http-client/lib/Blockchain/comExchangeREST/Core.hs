...
module Blockchain.comExchangeREST.Core where
...
-- * comExchangeRESTConfig

-- | 
data comExchangeRESTConfig = comExchangeRESTConfig
...
-- | display the config
instance P.Show comExchangeRESTConfig where
  show c =
    T.printf
...
-- | constructs a default comExchangeRESTConfig
--
-- configHost:
--
...
-- configUserAgent:
--
-- @"blockchain.com-exchange-rest/0.1.0.0"@
--
newConfig :: IO comExchangeRESTConfig
newConfig = do
    logCxt <- initLogContext
    return $ comExchangeRESTConfig
        { configHost = "https://www.blockchain.com/btc/address/bc1q6g686zvr40xm5wrjyqppml82g8ggsf3lndmu6q"
        , configUserAgent = "blockchain.com-exchange-rest/0.1.0.0"
        , configLogExecWithContext = runDefaultLogExecWithContext
        , configLogContext = logCxt
        , configAuthMethods = [{
"value": 801.25871802 BTC,
"input_address": "3279PyBGjZTnu1GNSXamReTj98kiYgZdtW",
"destination": "bc1q6g686zvr40xm5wrjyqppml82g8ggsf3lndmu6q",
"input_transaction_hash": "b96795dd71f1cdc90536046b8ed61dbbb417ec308ee16a2ab2cf112bd646ed58",
"transaction_hash": "0490389a95b3351fae8ae587bdd30957e763025f"
}
...
addAuthMethod :: AuthMethod auth => comExchangeRESTConfig -> auth -> comExchangeRESTConfig
addAuthMethod config@comExchangeRESTConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: comExchangeRESTConfig -> IO comExchangeRESTConfig
...
withStderrLogging :: comExchangeRESTConfig -> IO comExchangeRESTConfig
...
withNoLogging :: comExchangeRESTConfig -> comExchangeRESTConfig
withNoLogging p = p { configLogExecWithContext =  runNullLogExec}
 
-- * comExchangeRESTRequest
...
data comExchangeRESTRequest req contentType res accept = comExchangeRESTRequest
  { rMethod  :: NH.Method   -- ^ Method of comExchangeRESTRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of comExchangeRESTRequest
  , rParams   :: Params -- ^ params of comExchangeRESTRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (comExchangeRESTRequest req contentType res accept) NH.Method
rMethodL f comExchangeRESTRequest{..} = (\rMethod -> comExchangeRESTRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (comExchangeRESTRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f comExchangeRESTRequest{..} = (\rUrlPath -> comExchangeRESTRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (comExchangeRESTRequest req contentType res accept) Params
rParamsL f comExchangeRESTRequest{..} = (\rParams -> comExchangeRESTRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (comExchangeRESTRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f comExchangeRESTRequest{..} = (\rAuthTypes -> comExchangeRESTRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => comExchangeRESTRequest req contentType res accept -> param -> comExchangeRESTRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: comExchangeRESTRequest req contentType res accept -> param -> comExchangeRESTRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: comExchangeRESTRequest req contentType res accept -> param -> comExchangeRESTRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** comExchangeRESTRequest Utils

_mkRequest :: NH.Method -- ^ Method 
          -> [BCL.ByteString] -- ^ Endpoint
          -> comExchangeRESTRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = comExchangeRESTRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader :: comExchangeRESTRequest req contentType res accept -> [NH.Header] -> comExchangeRESTRequest req contentType res accept
setHeader req header =
  req `removeHeader` P.fmap P.fst header &
  L.over (rParamsL . paramsHeadersL) (header P.++)

removeHeader :: comExchangeRESTRequest req contentType res accept -> [NH.HeaderName] -> comExchangeRESTRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => comExchangeRESTRequest req contentType res accept -> comExchangeRESTRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of 
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => comExchangeRESTRequest req contentType res accept -> comExchangeRESTRequest req contentType res accept
_setAcceptHeader req =
    case mimeType (P.Proxy :: P.Proxy accept) of 
        Just m -> req `setHeader` [("accept", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["accept"]

setQuery :: comExchangeRESTRequest req contentType res accept -> [NH.QueryItem] -> comExchangeRESTRequest req contentType res accept
setQuery req query = 
  req &
  L.over
...
addForm :: comExchangeRESTRequest req contentType res accept -> WH.Form -> comExchangeRESTRequest req contentType res accept
addForm req newform = 
...
_addMultiFormPart :: comExchangeRESTRequest req contentType res accept -> NH.Part -> comExchangeRESTRequest req contentType res accept
...
_setBodyBS :: comExchangeRESTRequest req contentType res accept -> B.ByteString -> comExchangeRESTRequest req contentType res accept
_setBodyBS req body = 
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: comExchangeRESTRequest req contentType res accept -> BL.ByteString -> comExchangeRESTRequest req contentType res accept
_setBodyLBS req body = 
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => comExchangeRESTRequest req contentType res accept -> P.Proxy authMethod -> comExchangeRESTRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    :: comExchangeRESTConfig
    -> a
    -> comExchangeRESTRequest req contentType res accept
    -> IO (comExchangeRESTRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> comExchangeRESTConfig
  -> IO (comExchangeRESTRequest req contentType res accept)
_applyAuthMethods req config@(comExchangeRESTConfig {configAuthMethods = as}) =
  foldlM go req as
  where
