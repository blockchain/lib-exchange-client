## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `Blockchain.com Exchange REST API`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the Blockchain.com Exchange REST API API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | Blockchain.comExchangeREST                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | blockchain.com-exchange-rest                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | comExchangeRESTConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | comExchangeRESTRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| Blockchain.comExchangeREST.Client    | use the "dispatch" functions to send requests       |
| Blockchain.comExchangeREST.Core      | core funcions, config and request types             |
| Blockchain.comExchangeREST.API       | construct api requests                              |
| Blockchain.comExchangeREST.Model     | describes api models                                |
| Blockchain.comExchangeREST.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| Blockchain.comExchangeREST.ModelLens | lenses for model fields                             |
| Blockchain.comExchangeREST.Logging   | logging functions and utils                         |
