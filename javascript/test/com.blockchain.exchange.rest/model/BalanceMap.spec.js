...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BlockchainComExchangeRestApi.BalanceMap();
  });
  ...
  describe('BalanceMap', function() {
    it('should create an instance of BalanceMap', function() {
      // uncomment below and update the code to test BalanceMap
      //var instane = new BlockchainComExchangeRestApi.BalanceMap();
      //expect(instance).to.be.a(BlockchainComExchangeRestApi.BalanceMap);
    });
