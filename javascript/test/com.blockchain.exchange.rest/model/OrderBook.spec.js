...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BlockchainComExchangeRestApi.OrderBook();
  });
  ...
  describe('OrderBook', function() {
    it('should create an instance of OrderBook', function() {
      ...
      //var instane = new BlockchainComExchangeRestApi.OrderBook();
      //expect(instance).to.be.a(BlockchainComExchangeRestApi.OrderBook);
    });
