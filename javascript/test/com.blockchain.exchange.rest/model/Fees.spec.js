...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BlockchainComExchangeRestApi.Fees();
  });
  ...
  describe('Fees', function() {
    it('should create an instance of Fees', function() {
      // uncomment below and update the code to test Fees
    ...
    it('should have the property takerRate (base name: "takerRate")', function() {
      // uncomment below and update the code to test the property takerRate
      //var instane = new BlockchainComExchangeRestApi.Fees();
      //expect(instance).to.be();
    });

    it('should have the property volumeInUSD (base name: "volumeInUSD")', function() {
      // uncomment below and update the code to test the property volumeInUSD
      //var instane = new BlockchainComExchangeRestApi.Fees();
      //expect(instance).to.be();
    });
