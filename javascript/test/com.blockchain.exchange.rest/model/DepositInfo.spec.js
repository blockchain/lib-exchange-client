...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BlockchainComExchangeRestApi.DepositInfo();
  });
  ...
  describe('DepositInfo', function() {
    it('should create an instance of DepositInfo', function() {
      // uncomment below and update the code to test DepositInfo
      //var instane = new BlockchainComExchangeRestApi.DepositInfo();
      //expect(instance).to.be.a(BlockchainComExchangeRestApi.DepositInfo);
    });
