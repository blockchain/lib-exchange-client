...
(function(root, factory) {
  ...
  describe('Side', function() {
    it('should create an instance of Side', function() {
      // uncomment below and update the code to test Side
      //var instane = new BlockchainComExchangeRestApi.Side();
      //expect(instance).to.be.a(BlockchainComExchangeRestApi.Side);
    });
