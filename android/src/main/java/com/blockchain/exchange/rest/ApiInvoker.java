...
import com.blockchain.exchange.rest.auth.Authentication;
import com.blockchain.exchange.rest.auth.ApiKeyAuth;
import com.blockchain.exchange.rest.auth.HttpBasicAuth;
import com.blockchain.exchange.rest.request.GetRequest;
import com.blockchain.exchange.rest.request.PostRequest;
import com.blockchain.exchange.rest.request.PutRequest;
import com.blockchain.exchange.rest.request.DeleteRequest;
import com.blockchain.exchange.rest.request.PatchRequest;
...
public class ApiInvoker {
  ...
  */
  ...
  public static void initializeInstance(Cache cache, Network network, int threadPoolSize, ResponseDelivery delivery, int connectionTimeout) {
    ...
    INSTANCE.authentications.put("ApiKeyAuth", new ApiKeyAuth("header", "X-API-Token"));
