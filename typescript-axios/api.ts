...
export const TradingApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getOrders: async (symbol?: string, from?: number, to?: number, status?: OrderStatus, limit?: number, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/orders`;
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            let baseOptions;
            if (configuration) {
...
export const TradingApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getOrders(symbol?: string, from?: number, to?: number, status?: OrderStatus, limit?: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<OrderSummary>>> {
            const localVarAxiosArgs = await TradingApiAxiosParamCreator(configuration).getOrders(symbol, from, to, status, limit, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const TradingApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        getOrders(symbol?: string, from?: number, to?: number, status?: OrderStatus, limit?: number, options?: any): AxiosPromise<Array<OrderSummary>> {
            return TradingApiFp(configuration).getOrders(symbol, from, to, status, limit, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class TradingApi extends BaseAPI {
     ...
     * @memberof TradingApi
     */
    public getOrders(symbol?: string, from?: number, to?: number, status?: OrderStatus, limit?: number, options?: any) {
        return TradingApiFp(this.configuration).getOrders(symbol, from, to, status, limit, options).then((request) => request(this.axios, this.basePath));
    }
