...
class OrderSummary implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^[a-zA-Z0-9]{1,20}$/", $this->container['cl_ord_id'])) {
            $invalidProperties[] = "invalid value for 'cl_ord_id', must be conform to the pattern /^[a-zA-Z0-9]{1,20}$/.";
        }
     ...
     * Sets cl_ord_id
     *
     * @param string $cl_ord_id Reference field provided by client. Cannot exceed 20 characters, only alphanumeric characters are allowed.
     *
     * @return $this
     */
    public function setClOrdId($cl_ord_id)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9]{1,20}$/", $cl_ord_id))) {
            throw new \InvalidArgumentException("invalid value for $cl_ord_id when calling OrderSummary., must conform to the pattern /^[a-zA-Z0-9]{1,20}$/.");
        }
