...
/**
 * OrderBookEntry Class Doc Comment
 *
 * @category Class
 * @package  com.blockchain.exchange.rest
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class OrderBookEntry implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderBookEntry';
    ...
    {
        $this->container['px'] = isset($data['px']) ? $data['px'] : null;
    ...
    {
        return $this->container['px'];
    }

    /**
     * Sets px
     *
     * @param double|null $px px
     *
     * @return $this
     */
    public function setPx($px)
    {
        $this->container['px'] = $px;
