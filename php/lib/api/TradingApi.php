...
class TradingApi
{
     ...
     * @param  int $page Page number, starting at 0, for paginated responses (optional)
     *
     * @throws \com.blockchain.exchange.rest\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \com.blockchain.exchange.rest\com.blockchain.exchange.rest.model\OrderSummary[]
     */
    public function getOrders($symbol = null, $from = null, $to = null, $status = null, $page = null)
    {
        list($response) = $this->getOrdersWithHttpInfo($symbol, $from, $to, $status, $page);
        return $response;
    }
     ...
     * @return array of \com.blockchain.exchange.rest\com.blockchain.exchange.rest.model\OrderSummary[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrdersWithHttpInfo($symbol = null, $from = null, $to = null, $status = null, $page = null)
    {
        $request = $this->getOrdersRequest($symbol, $from, $to, $status, $page);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrdersAsync($symbol = null, $from = null, $to = null, $status = null, $page = null)
    {
        return $this->getOrdersAsyncWithHttpInfo($symbol, $from, $to, $status, $page)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrdersAsyncWithHttpInfo($symbol = null, $from = null, $to = null, $status = null, $page = null)
    {
        $returnType = '\com.blockchain.exchange.rest\com.blockchain.exchange.rest.model\OrderSummary[]';
        $request = $this->getOrdersRequest($symbol, $from, $to, $status, $page);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getOrdersRequest($symbol = null, $from = null, $to = null, $status = null, $page = null)
    {
        if ($symbol !== null && !preg_match("/^[A-Z]{3,5}-[A-Z]{3,5}$/", $symbol)) {
