...
class TradingApi
{
    ...
    {
        list($response) = $this->getFillsWithHttpInfo($symbol, $from, $to, $limit);
        return $response;
    }

    /**
     * Operation getFillsWithHttpInfo
     *
     * Get a list of filled orders
     *
     * @param  string $symbol Only return results for this symbol (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getFillsAsync($symbol = null, $from = null, $to = null, $limit = null)
    {
        return $this->getFillsAsyncWithHttpInfo($symbol, $from, $to, $limit)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getFillsAsyncWithHttpInfo
     *
     * Get a list of filled orders
     *
     * @param  string $symbol Only return results for this symbol (optional)
    ...
    /**
     * Create request for operation 'getFills'
     *
     * @param  string $symbol Only return results for this symbol (optional)
     * @param  int $from Epoch timestamp in ms (optional)
     * @param  int $to Epoch timestamp in ms (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getFillsRequest($symbol = null, $from = null, $to = null, $limit = null)
    {
        if ($symbol !== null && !preg_match("/^[A-Z]{3,5}-[A-Z]{3,5}$/", $symbol)) {
            throw new \InvalidArgumentException("invalid value for \"symbol\" when calling TradingApi.getFills, must conform to the pattern /^[A-Z]{3,5}-[A-Z]{3,5}$/.");
        }

        if ($limit !== null && $limit > 1000) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling TradingApi.getFills, must be smaller than or equal to 1000.');
        }
        if ($limit !== null && $limit < 1) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling TradingApi.getFills, must be bigger than or equal to 1.');
        }
