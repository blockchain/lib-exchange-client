...
class WithdrawalStatus(object):
    ...
    allowable_values = [REJECTED, PENDING, REFUNDED, FAILED, COMPLETED]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """WithdrawalStatus - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WithdrawalStatus):
            return False
