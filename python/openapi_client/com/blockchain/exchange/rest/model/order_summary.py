...
class OrderSummary(object):
    ...
    def cl_ord_id(self):
        ...
        Reference field provided by client. Cannot exceed 20 characters, only alphanumeric characters are allowed.  # noqa: E501
    ...
    def cl_ord_id(self, cl_ord_id):
        ...
        if (self.local_vars_configuration.client_side_validation and
                cl_ord_id is not None and not re.search(r'^[a-zA-Z0-9]{1,20}$', cl_ord_id)):  # noqa: E501
            raise ValueError(r"Invalid value for `cl_ord_id`, must be a follow pattern or equal to `/^[a-zA-Z0-9]{1,20}$/`")  # noqa: E501
