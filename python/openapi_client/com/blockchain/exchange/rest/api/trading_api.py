...
class TradingApi(object):
    ...
    def get_fills(self, **kwargs):  # noqa: E501
        """Get a list of filled orders  # noqa: E501

        Returns filled orders, including partial fills. Returns at most 100 results, use timestamp to paginate for further results  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_fills_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'symbol' in local_var_params and not re.search(r'^[A-Z]{3,5}-[A-Z]{3,5}$', local_var_params['symbol']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `symbol` when calling `get_fills`, must conform to the pattern `/^[A-Z]{3,5}-[A-Z]{3,5}$/`")  # noqa: E501
        if self.api_client.client_side_validation and 'limit' in local_var_params and local_var_params['limit'] > 1000:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `limit` when calling `get_fills`, must be a value less than or equal to `1000`")  # noqa: E501
        if self.api_client.client_side_validation and 'limit' in local_var_params and local_var_params['limit'] < 1:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `limit` when calling `get_fills`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
