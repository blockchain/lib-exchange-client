...
class PaymentsApi(object):
    ...
    def create_withdrawal(self, create_withdrawal_request, **kwargs):  # noqa: E501
        ...
        Call `GET /whitelist` first to retrieve the ID of the beneficiary. To add a beneficiary to the whitelist, please visit the profile page in the Exchange. This call only works if 2FA is enabled on the account.  # noqa: E501
