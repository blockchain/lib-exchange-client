...
namespace Org.OpenAPITools.com.blockchain.exchange.rest.api
{
    ...
    public partial class PaymentsApi : IPaymentsApi
    {
        ...
        /// <summary>
        /// Request a withdrawal Call &#x60;GET /whitelist&#x60; first to retrieve the ID of the beneficiary. To add a beneficiary to the whitelist, please visit the profile page in the Exchange. This call only works if 2FA is enabled on the account.
        /// </summary>
        /// <exception cref="Org.OpenAPITools.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="createWithdrawalRequest"></param>
        /// <returns>WithdrawalInfo</returns>
