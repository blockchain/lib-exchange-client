...
namespace Org.OpenAPITools.com.blockchain.exchange.rest.api
{
    ...
    public interface ITradingApi : IApiAccessor
    {
        ...
        /// <param name="page">Page number, starting at 0, for paginated responses (optional)</param>
        /// <returns>List&lt;OrderSummary&gt;</returns>
        List<OrderSummary> GetOrders (string symbol = default(string), long? from = default(long?), long? to = default(long?), OrderStatus? status = default(OrderStatus?), long? page = default(long?));
        ...
        ApiResponse<List<OrderSummary>> GetOrdersWithHttpInfo (string symbol = default(string), long? from = default(long?), long? to = default(long?), OrderStatus? status = default(OrderStatus?), long? page = default(long?));
        ...
        System.Threading.Tasks.Task<List<OrderSummary>> GetOrdersAsync (string symbol = default(string), long? from = default(long?), long? to = default(long?), OrderStatus? status = default(OrderStatus?), long? page = default(long?));
        ...
        System.Threading.Tasks.Task<ApiResponse<List<OrderSummary>>> GetOrdersAsyncWithHttpInfo (string symbol = default(string), long? from = default(long?), long? to = default(long?), OrderStatus? status = default(OrderStatus?), long? page = default(long?));
    ...
    public partial class TradingApi : ITradingApi
    {
        ...
        /// <summary>
        /// Get a list orders Returns live and historic orders, defaulting to live orders. Returns at most 50 results, use pagination to return further results
        /// </summary>
        /// <exception cref="Org.OpenAPITools.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="symbol">Only return results for this symbol (optional)</param>
        /// <param name="from">Epoch timestamp in ms (optional)</param>
        ...
        /// <param name="page">Page number, starting at 0, for paginated responses (optional)</param>
        /// <returns>List&lt;OrderSummary&gt;</returns>
        public List<OrderSummary> GetOrders (string symbol = default(string), long? from = default(long?), long? to = default(long?), OrderStatus? status = default(OrderStatus?), long? page = default(long?))
        {
             ApiResponse<List<OrderSummary>> localVarResponse = GetOrdersWithHttpInfo(symbol, from, to, status, page);
             return localVarResponse.Data;
        }
        ...
        /// <param name="page">Page number, starting at 0, for paginated responses (optional)</param>
        /// <returns>ApiResponse of List&lt;OrderSummary&gt;</returns>
        public ApiResponse<List<OrderSummary>> GetOrdersWithHttpInfo (string symbol = default(string), long? from = default(long?), long? to = default(long?), OrderStatus? status = default(OrderStatus?), long? page = default(long?))
        {
        ...
        /// <param name="page">Page number, starting at 0, for paginated responses (optional)</param>
        /// <returns>Task of List&lt;OrderSummary&gt;</returns>
        public async System.Threading.Tasks.Task<List<OrderSummary>> GetOrdersAsync (string symbol = default(string), long? from = default(long?), long? to = default(long?), OrderStatus? status = default(OrderStatus?), long? page = default(long?))
        {
             ApiResponse<List<OrderSummary>> localVarResponse = await GetOrdersAsyncWithHttpInfo(symbol, from, to, status, page);
             return localVarResponse.Data;
        ...
        /// <param name="page">Page number, starting at 0, for paginated responses (optional)</param>
        /// <returns>Task of ApiResponse (List&lt;OrderSummary&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<OrderSummary>>> GetOrdersAsyncWithHttpInfo (string symbol = default(string), long? from = default(long?), long? to = default(long?), OrderStatus? status = default(OrderStatus?), long? page = default(long?))
        {
