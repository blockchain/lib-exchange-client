...
namespace Org.OpenAPITools.com.blockchain.exchange.rest.model
{
    ...
    public partial class OrderSummary :  IEquatable<OrderSummary>, IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            Regex regexClOrdId = new Regex(@"^[a-zA-Z0-9]{1,20}$", RegexOptions.CultureInvariant);
            if (false == regexClOrdId.Match(this.ClOrdId).Success)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ClOrdId, must match a pattern of " + regexClOrdId, new [] { "ClOrdId" });
            }
